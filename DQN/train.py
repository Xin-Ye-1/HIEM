...
flags.DEFINE_multi_string('default_targets',
                          ...
                          'Default targets.')
flags.DEFINE_float('termination_reg', 0.005, 'Termination regularization.')
...
def set_up():
    ...
    with graph.as_default():
        ...
        lowlevel_network_main = Lowlevel_Network(window_size=FLAGS.window_size,
                                                 num_labels=FLAGS.num_labels,
                                                 action_size=FLAGS.a_size,
                                                 history_steps=FLAGS.history_steps,
                                                 scope='global/in/main')

        lowlevel_network_ex_main = Lowlevel_Network_ex(window_size=FLAGS.window_size,
                                                       num_labels=FLAGS.num_labels,
                                                       action_size=FLAGS.a_size,
                                                       history_steps=FLAGS.history_steps,
                                                       scope='global/ex/main')
        lowlevel_network_ex_target = Lowlevel_Network_ex(window_size=FLAGS.window_size,
                                                         num_labels=FLAGS.num_labels,
                                                         action_size=FLAGS.a_size,
                                                         history_steps=FLAGS.history_steps,
                                                         scope='global/ex/target')
        ...
        for i in range(FLAGS.num_threads):
            local_highlevel_network = Highlevel_Network(window_size=FLAGS.window_size,
                                                        ...
                                                        history_steps=FLAGS.history_steps,
                                                        scope='local_%d'%i)
            local_lowlevel_network = Lowlevel_Network_ex(window_size=FLAGS.window_size,
                                                         num_labels=FLAGS.num_labels,
                                                         action_size=FLAGS.a_size,
                                                         history_steps=FLAGS.history_steps,
                                                         scope='local_%d/ex'%i)
            worker = Worker(name=i,
                            ...
                            lowlevel_networks=(lowlevel_network_main, local_lowlevel_network, lowlevel_network_ex_target),
