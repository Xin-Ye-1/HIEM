...
def set_up():
    ...
    with graph.as_default():
        ...
        lowlevel_network_target = Lowlevel_Network(window_size=FLAGS.window_size,
                                                   num_labels=FLAGS.num_labels,
                                                   action_size=FLAGS.a_size,
                                                   history_steps=FLAGS.history_steps,
                                                   scope='global/in/target')

        lowlevel_network_ex = Lowlevel_Network_ex(window_size=FLAGS.window_size,
                                                  num_labels=FLAGS.num_labels,
                                                  action_size=FLAGS.a_size,
                                                  history_steps=FLAGS.history_steps,
                                                  scope='global/ex')
        ...
        for i in range(FLAGS.num_threads):
            ...
            local_lowlevel_network = Lowlevel_Network(window_size=FLAGS.window_size,
                                                      ...
                                                      history_steps=FLAGS.history_steps,
                                                      scope='local_%d/in'%i)
            local_lowlevel_network_ex = Lowlevel_Network_ex(window_size=FLAGS.window_size,
                                                            num_labels=FLAGS.num_labels,
                                                            action_size=FLAGS.a_size,
                                                            history_steps=FLAGS.history_steps,
                                                            scope='local_%d/ex' % i)
            worker = Worker(name=i,
                            ...
                            lowlevel_networks=(local_lowlevel_network, lowlevel_network_target, local_lowlevel_network_ex),
